...
Para desbloquear este rango necesitas ser un devoto seguidor de un dios o espíritu mayor además de 2 o más inteligencia y un nivel de talento en estudio (religión). Puedes obtener este rango de manera gratuita si también cumples los requisitos del rango III.

<u>Milagro menor</u> (acción bonus): Tu deidad te permite dar pequeñas maldiciones y bendiciones a criaturas de tu elección. Como acción bonus una criatura de tu elección puede repetir un tiro de ataque, habilidad o defensa y quedarse con el mejor resultado. Esta habilidad se puede usarse un número de veces al día igual a tu Rango + 2 y también puede emplearse para recibir una pequeña ayuda de tu dios no relacionada con el combate.
