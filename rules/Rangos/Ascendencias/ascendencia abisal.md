...
<u>Vista del vacío</u> (pasiva): Tienes visión a ciegas en un área de 30 pies y visión a oscuras en 60 pies. Detectas influencias abisales en un área de hasta una milla (no conocerás su posición ni cantidad solo su fuerza).

## Rango III

Aumenta tu resistencia a daño físico por 1

<u>Infección</u> (pasiva): Al hacer daño con un ataque natural puedes infectar a tu objetivo con una plaga abisal. Esta [enfermedad](https://raldamain.com/rules/Reglas%20adicionales/venenos_enfermedades.html#enfermedades) es de naturaleza física y tiene un tiro de gravedad igual a tu CON + 1. Si obtienes un golpe crítico esta enfermedad actuará con la misma velocidad que un [veneno](https://raldamain.com/rules/Reglas%20adicionales/venenos_enfermedades.html#venenos). No puedes volver a afectar con plaga abisal a una criatura que se haya recuperado de este efecto hasta que pase un día.

<u>Transformación</u> (pasiva): Al usar fuerza del abismo recibes un bonificador igual a tu rango de ascendencia - 1 en todos tus tiros de ataque o ataques mágicos. Si activas este bonificador perderás la capacidad de utilizar habilidades que requieran concentración y esfuerzo mental salvo aquellas relacionadas con ascendencia abisal.
...
<u>Invocación abisal</u> (3 acciones): 
