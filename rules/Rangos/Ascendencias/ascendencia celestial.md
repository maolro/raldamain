...
<u>Bendito por el cielo</u> (pasiva) Puedes lanzar hechizos divinos usando tu estadística de carisma en vez de sabiduría. Tienes además resistencia igual a tu Rango contra daño necrótico y radiante. Adicionalmente al utilizar [*primeros auxilios*](https://raldamain.com/rules/Crear%20personajes/talentos.html#primeros-auxilios-sab) sanarás una cantidad de Vitalidad igual a 1d4 + CAR y una vez al día puedes reducir el nivel de un veneno o herida permanente por un paso (2 veces al día a rango III y 3 veces a rango V). Si tienes la habilidad *toque sanador* aumenta la cantidad de Vitalidad que sanas por 1d4 y la cantidad de veces que puedes reducir una herida permanente por ambas habilidade
...
<u>Alas del ángel</u> (pasiva): Eres capaz de manifestar alas celestiales empleando 2 acciones, las cuales te otorgan una velocidad de vuelo de 60 pies. Volver a ocultar tus alas te cuesta también te cuesta 2 acciones. Puedes sustituir esta habilidad por otras características similares que no sumen más de 3 [PT](https://raldamain.com/rules/Reglas adicionales/crear criaturas.html#puntos-de-transformación) entre ellas.

<u>Ángel protector</u> (pasiva): Una entidad celestial se dedica a protegerte del daño y guiarte hacia el bien. Esta entidad te permite entrar en *posición defensiva* como acción bonus y una vez por combate te permite repetir un tiro defensivo de tu elección. Empleando dos acciones puedes manifestar a tu ángel protector, el cual es una criatura celestial de nivel 4. Cada vez que subas de rango tu ángel protector recibirá 2 niveles adicionales. Si tu ángel protector muere pierdes todas las bonificaciones defensivas que te otorga durante un día.
...
<u>Milagro de restauración</u> (2 acciones): El poder del cielo te permite sanar hasta las más profundas heridas. Una cantidad de veces al día igual a tu rango - 2 puedes hacer intento de *primeros auxilios* para el cual le sumas tu rango en ascendencia celestial para sanar un [efecto de estado](https://raldamain.com/rules/Reglas principales/Efectos de estado.html), [veneno](https://raldamain.com/rules/Reglas adicionales/venenos_enfermedades.html#venenos), [enfermedad](https://raldamain.com/rules/Reglas adicionales/venenos_enfermedades.html#enfermedades), maldición o hechizo que afecte a una criatura, tirando contra la gravedad de dicho efecto.
