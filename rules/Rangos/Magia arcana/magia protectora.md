...
- **Reserva de Chi**: Tu rango de magia Protectora mejorará tu reserva de chi, incrementándola por un valor igual a tu Rango + 2. Esto se acumula con otras habilidades que te otorguen esta misma reserva. 
- **Estadística principal**: Tu modificador de magia Protectora será igual a la suma de tu estadística de Inteligencia y tu rango en esta habilidad.
- **Parada mágica:** Eres capaz de usar magia Protectora para defenderte de ataques de todo tipo, permitiéndote usar tu modificador de magia Parada para tiros de parada. Este modificador también se puede usar para tiros de salvación para protegerte de habilidades Arcanas, sustituyendo el talento que usarías normalmente.
