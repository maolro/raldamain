...
<u>Campo de fuerza:</u> Tu armadura genera un campo de fuerza formado por chi que te protege de ataques y se regenera al ser dañado. Activar el campo te cuesta una acción estándar y mientras esté activo recibes 2 PV temporales, los cuales se regeneran a la velocidad de 1 PV por ronda. El campo de fuerza puede permanecer en funcionamiento hasta 10 rondas al día. Cada vez que subas tres niveles puedes gastar recursos para incrementar la resistencia del campo de fuerza, lo cual aumentará el número de PV temporales que otorga por 1. A nivel 10 el número de PV que regenera tu campo de fuerza aumenta por 1. Un campo de fuerza cuenta como dos mejoras para determinar el número máximo de mejoras que puede tener tu armadura.
