...
<u>Reinforced defense</u>: Increase your defense by 2 if you are wearing armor. The defense is increased again by 1 each time you get a rank in suitability with armor. This increase in defense also reduces the damage from non-magical attacks against which your armor is not applied, such as [Deadly aim](../../../../rules/ranks/weapons/firearms.md#rank-i).
...
<u>Steel Champion</u>: Armor protects you from even deadly attacks. Once a turn, reduce the level of a [permanent injury](../../../../rules/main rules/permanent injuries.md) you suffer by one step. You can also affect instant death attacks such as [master hunter](../../../../rules/ranks/combat/track.md#rank-v), making them only cause you a serious permanent injury.
