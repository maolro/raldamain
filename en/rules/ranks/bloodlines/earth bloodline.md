...
<u>Infused Attacks:</u> Your physical attacks increase their base damage by 2 and are coated with solid stones, counting as adamantine for the purposes of determining what materials they can break (if you have [Devastating strike](../weapons/natural attacks.md#range-iv) you can use this ability on all infused attacks). If you use earthen fists on an infused attack you gain the ability to reduce your target's DEF by 2 on hit. 
